...
#
# https://github.com/aenglebert/Transformer_Input_Sampling/blob/main/metrics/deletion.py
# ----------------------------------------------------------------------
...
class Deletion(RelevanceMetric):
    def __init__(self, model, n_steps, batch_size, baseline="blur"):
        ...
        """
        super(Deletion, self).__init__(model, n_steps, batch_size, baseline=baseline)
